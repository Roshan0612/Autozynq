...
export function CreateFolderConfig({ config, onConfigChange, connectionId }: CreateFolderConfigProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        {!loading && !error && (
          <>
            <Select value={config?.parentFolderId || ""} onValueChange={handleFolderSelect}>
              <SelectTrigger>
